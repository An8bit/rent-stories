...
public final class ActivitySearchBinding implements ViewBinding {
  ...
  private ActivitySearchBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rvStory) {
  ...
  public static ActivitySearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySearchBinding((ConstraintLayout) rootView, rvStory);
    }
