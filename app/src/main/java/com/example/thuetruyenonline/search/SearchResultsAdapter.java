...
public class SearchResultsAdapter extends RecyclerView.Adapter<SearchResultsAdapter.DataSearchStory> {
    FirebaseStorage storage = FirebaseStorage.getInstance();
    ArrayList<Story> stories;
    Listener listener;

    public SearchResultsAdapter(ArrayList<Story> stories, Listener listener) {
    ...
    @NonNull
    @Override
    public DataSearchStory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View  view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_cell, parent,false);
        return new DataSearchStory(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DataSearchStory holder, int position) {
    ...
    class DataSearchStory extends RecyclerView.ViewHolder{

        TextView tvNameStory;
        ImageView ivAnh;
        public DataSearchStory(@NonNull View itemView) {
            super(itemView);
